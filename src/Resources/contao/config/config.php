...
(
	...
	(
		...
		(
			...
			'table'  => array('contao.backend_csv_import', 'importTableWizard'),
			'list'   => array('contao.backend_csv_import', 'importListWizard'),
		),
		'form' => array
		(
			'tables' => array('tl_form', 'tl_form_field'),
			'option' => array('contao.backend_csv_import', 'importOptionWizard'),
		)
	),
